# Disputes and Chargebacks Manager (F2) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    DISPUTES_PROFILE=gcp \
    DISPUTES_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m disputes_chargebacks_manager.managed_readiness && exec uvicorn disputes_chargebacks_manager.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
