...
from disputes_chargebacks_manager.adapters.gcp.identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("disputes_chargebacks_manager.adapters.gcp.identity")
