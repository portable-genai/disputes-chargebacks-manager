# ARCHITECTURE: Disputes and Chargebacks Manager (F2)

Hexagonal ports-and-adapters. A pure-stdlib domain core speaks only to ports (`typing.Protocol`s);
adapter families implement them; one env var (`DISPUTES_PROFILE`) swaps the
...
## Layout (`src/disputes_chargebacks_manager/`)
