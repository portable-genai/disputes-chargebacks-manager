...
* The SERVICE-TO-SERVICE secret authenticates a calling SERVICE. It authenticates no end user,
  so its presence is not evidence that ``/v1/disputes/open`` is protected. Deriving the guard
  from it is how setting a credential came to SWITCH THE GUARD OFF for the routes it protects.
